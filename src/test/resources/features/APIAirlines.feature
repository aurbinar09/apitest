...
#Alexandro
@CP03
  Scenario: Eliminar un pasajero
    Given el actor establece el endpount DELETE para eliminar un pasajero
    When el envia una solicitud HTTP DELETE con el ID "674cf40b7a3b2924525df95e"
    Then el codigo de respuesta deberia ser 200
#Alexandro
@CP04
  Scenario Outline: Actualizar un pasajero
  Given el actor establece el endpoint PATCH para actualizar un campo de un pasajero
  When el envia una solicitud HTTP PATCH con el ID "<_id>" para cambiar el nombre a"<name>"
  Then el codigo de respuesta deberia ser 200
  Examples:
    | _id                      |   name  |
    |667ab79f7ad8fbf2544343d9 |   Jenny |
    |667ab79e7ad8fb6bef4343d4 |   Jenny |